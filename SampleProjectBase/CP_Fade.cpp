...
void CP_Fade::Load(const nlohmann::json& _data)
{
	...
	HashiTaku::LoadJsonBoolean("startOpen", isStartOpen, _data);
	HashiTaku::LoadJsonFloat("openTime", fadeOpenTime, _data);
	HashiTaku::LoadJsonFloat("closeTime", fadeCloseTime, _data);
}
